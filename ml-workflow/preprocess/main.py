...
def run(job_dir: str, csv_path: str, n_splits: int) -> None:
    ...
    df_train.to_csv(f'{job_dir}/train.csv', index=False)
    df_val.to_csv(f'{job_dir}/val.csv', index=False)
    print(f'Save train/val data to: {job_dir}')
